...
public class SortProfiler {
   ...
   */
  public SortProfiler(ArrayList<Sorter<Integer>> sorts, ArrayList<String> sortNames, int start, int interval, int max, int trials, Generator gen) {
    if (start < 0) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      SortProfiler profiler = new SortProfiler(sorts, sortStrings, start, interval, max, trials, gen);
